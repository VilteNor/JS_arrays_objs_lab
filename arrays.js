/**
 * In these tasks you will need to manipulate the array below in order to answer the questions. Some answers will require 
 * you to store the result in a variable, others will need you to inspect the whole array.
 */
